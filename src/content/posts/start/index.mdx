---
title: 'Getting Started with Northwind Dental Studio'
description: 'Quick start for the Northwind Dental Studio site: prerequisites, setup, and the first publishing steps.'
pubDate: 2025-08-15
author: 'ndEX'
...
- :link[Fork the repository]{id=https://github.com/ndEX/Litos/fork}
- :link[Use this template]{id=https://github.com/ndEX/Litos/generate} - In the future, content-free branches will be launched, which do not require deleting and replacing content.
...
```bash
git remote add upstream https://github.com/ndEX/Litos.git
```
...
> - `src/content/` — Your posts and structured site content
